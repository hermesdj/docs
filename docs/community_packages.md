...
| [hermesdj/seat-calendar](https://github.com/hermesdj/seat-calendar)                           | [![Latest Stable Version](https://poser.pugx.org/kassie/calendar/v/stable?style=flat-square)](https://packagist.org/packages/kassie/calendar)                                                                                       | [![Latest Stable Version](https://img.shields.io/github/v/tag/hermesdj/seat-calendar?filter=1.*&style=flat-square&label=stable&color=%2328a3df)](https://packagist.org/packages/hermesdj/seat-calendar)                             | [Read the docs](https://github.com/hermesdj/seat-calendar/blob/master/README.md)       | Calendar plugin                                                                                                                                                                                                                                    |
...
| [hermesdj/seat-mining-scan-parser](https://github.com/hermesdj/seat-mining-scan-parser)         | ![SeAT 4.x incompatible](https://img.shields.io/badge/SeAT%204.x-not--available-critical?style=flat-square) | [![Latest Stable Version](https://img.shields.io/github/v/tag/hermesdj/seat-mining-scan-parser?filter=1.*&style=flat-square&label=stable&color=%2328a3df)](https://packagist.org/packages/hermesdj/seat-mining-scan-parser)         |                                                                                           | A tool for parsing a mineral scan and evaluate the content and value of a belt by regrouping per mineral type the results                                                                                                                          |
| [hermesdj/seat-planetary-industry](https://github.com/hermesdj/seat-planetary-industry)         | ![SeAT 4.x incompatible](https://img.shields.io/badge/SeAT%204.x-not--available-critical?style=flat-square) | [![Latest Stable Version](https://img.shields.io/github/v/tag/hermesdj/seat-planetary-industry?filter=1.*&style=flat-square&label=stable&color=%2328a3df)](https://packagist.org/packages/hermesdj/seat-planetary-industry)         |                                                                                           | Manage multiple characters PI on one page and create personal or corporation PI projects                                                                                                                                                           |
